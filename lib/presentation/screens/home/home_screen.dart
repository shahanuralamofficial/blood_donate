...
class _HomeScreenState extends ConsumerState<HomeScreen> {
      ...
      child: Row(
        children: [
          Container(
            ...
            child: Icon(
              isEligible ? Icons.check_rounded : Icons.timer_rounded,
              color: Colors.white,
              size: 20,
            ),
          ),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  isEligible
                      ? 'আপনি এখন রক্ত দান করতে পারবেন'
                      : 'পরবর্তী রক্তদানের জন্য অপেক্ষা করুন',
                  style: GoogleFonts.notoSansBengali(
                    fontWeight: FontWeight.bold,
                    fontSize: 14,
                    color: isEligible
                ...
                if (!isEligible)
                  Text(
                    'আরও $remainingDays দিন বাকি আছে।',
                    style: TextStyle(
                      fontSize: 12,
        ...
        myDon.when(
          data: (donations) {
            ...
            final completed = active
                .where((d) => d.status == 'completed' && d.thankYouNote != null)
                .toList();
            final others = active
  ...
  Widget _buildThankYouSectionFromAsync(
    AsyncValue<List<BloodRequestModel>> myDonations,
  ) {
    ...
    return Column(
      ...
      children: [
        _buildSectionHeader('প্রাপ্ত ধন্যবাদ বার্তা', () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (_) => const AppreciationScreen()),
          );
        }),
        const SizedBox(height: 12),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            req.thankYouNote ??
                'রক্তদানের মাধ্যমে একটি প্রাণ বাঁচানোর জন্য আপনাকে অসংখ্য ধন্যবাদ!',
            style: GoogleFonts.notoSansBengali(
  ...
  Widget _buildRequestList(AsyncValue<List<BloodRequestModel>> requestsAsync) {
    return requestsAsync.when(
      ...
      data: (requests) {
        ...
        final sorted = List<BloodRequestModel>.from(requests)
